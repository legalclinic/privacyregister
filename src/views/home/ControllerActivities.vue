...
<script>
const STORAGE_KEY = 'avg_list_controller';
export default {
  data() {
    return {
      newItem: {},
      formName: 'formController',
      redirect: '/home/activities-controller',
      editedItem: null,
      selectedRows: [],
      addRow: false,
      ...
      fields: [
        ...
        {
          key: 'processActivity',
          label: 'Name data processing activity',
          sortable: true,
          edit: false,
        },
        {
          key: 'legitimate',
          label: 'Purpose of processing activity',
          sortable: true,
          edit: false,
        },
        {
        ...
        },
        {
          ...
          label: 'Special personal data categories',
          sortable: true,
          edit: false,
        },
        {
        ...
        {
          key: 'countries',
          label: 'Transfers of personal',
          sortable: true,
          edit: false,
        },
        {
          key: 'dataTransfer',
          label: 'External transfers of personal',
          sortable: true,
          edit: false,
        },
        {
      ...
      items: [],
      singleQuestions: ['personalDataCategory', 'personalDataSpecial', 'legalBase'],
      singleQuestionKey: '',
      singleRow: [],
    };
  },
